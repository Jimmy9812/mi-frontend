...
function transformFrontendToBackend(payload) {
  return {
    ...
    predio: payload.numero_predio || payload.predio || undefined,
    clave_catastral: payload.clave_catastral || undefined,
    nom_propietario: payload.propietario || payload.nom_propietario || undefined,
    documento: payload.numero_documento || payload.documento || undefined,
    cod_consulta: payload.codigo_consulta || payload.cod_consulta || undefined,
